...
export const GeminiIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M12 2.75C11.1716 2.75 10.5 3.42157 10.5 4.25C10.5 5.07843 11.1716 5.75 12 5.75C12.8284 5.75 13.5 5.07843 13.5 4.25C13.5 3.42157 12.8284 2.75 12 2.75Z" />
        <path d="M5.75 7.5C4.92157 7.5 4.25 8.17157 4.25 9C4.25 9.82843 4.92157 10.5 5.75 10.5C6.57843 10.5 7.25 9.82843 7.25 9C7.25 8.17157 6.57843 7.5 5.75 7.5Z" />
        <path d="M12 7.5C10.067 7.5 8.5 9.067 8.5 11V16.5C8.5 18.433 10.067 20 12 20C13.933 20 15.5 18.433 15.5 16.5V11C15.5 9.067 13.933 7.5 12 7.5Z" />
        <path d="M18.25 15C17.4216 15 16.75 15.6716 16.75 16.5C16.75 17.3284 17.4216 18 18.25 18C19.0784 18 19.75 17.3284 19.75 16.5C19.75 15.6716 19.0784 15 18.25 15Z" />
    </svg>
);
